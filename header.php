...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong>MonkaS Restaurant</strong>
            </a>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    if(isset($_SESSION['user_id'])){ 
                        if($_SESSION['role']==1) {
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="view_preorder.php" >Food Pre-order</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view_reservations.php" >View Reservations</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view_menu.php" >View Restaurant Menu</a>
                            </li>';
                        }
                        //<li class="nav-item">
                        //<a class="nav-link" href="preorder_food.php" >Pre-Order Food</a>
                        //</li>
                        ...
                        if($_SESSION['role']==2) {   
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="manage_menu.php" >Manage Restaurant Menu</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view_reservations.php" >View Reservations</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view_preorder.php" >View Food Pre-order List</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="restaurant_menu.php">Restaurant Menu</a>
                    </li>
                    <li class="nav-item">
            ...
            <!-- Modal body -->
                ...
                if(isset($_GET['error'])){
                    ...
                    if($_GET['error'] == "emptyfields") {   
                        ...
                        echo '<h5 class="bg-danger text-center">Invalid Username. No Spacing is allowed. Please try again!</h5>';
                    }
                    else if($_GET['error'] == "invalidpassword") {   
                        echo '<h5 class="bg-danger text-center">Invalid password. Password must have more than 6 characters. Please try again!</h5>';
                    }
    ...
    <!---sign up form -->
                    <div class="signup-form">
                        <form action="includes/signup.inc.php" method="post">
                            <p class="hint-text">Create your account for FREE!</p>
                            <div class="form-group">
